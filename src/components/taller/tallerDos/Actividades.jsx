...
export default function ActividadesTallerDos() {
  ...
  const actividades = [
    {
      ...
      dinamica: [
        ...
        'Repaso de las herramientas de ArcGIS Online para creación de historias de datos: Story Maps, Instant Apps y Dashboards.',
  ...
  const infoGeneral = {
    ...
    fecha: '18 ó 25 de septiembre (tentativo)',
