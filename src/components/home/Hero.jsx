...
export default function Hero() {
  return (
  <section className="relative w-full py-16 sm:py-20 md:py-24 bg-slate-900 border-b border-slate-800 overflow-hidden">
  ...
  <div className="max-w-5xl mx-auto px-4 sm:px-6 text-center relative z-10">
    ...
    {/* Insignia pequeña */}
    <div className="inline-block px-4 py-1.5 mb-6 text-xs sm:text-sm font-medium text-blue-400 bg-blue-900/30 border border-blue-800 rounded-full">
      Desde 2006
    </div>
