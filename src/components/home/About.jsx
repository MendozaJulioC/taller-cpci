...
export default function About() {
  const objectives = [
    ...
    },
    {
      ...
      reto: 'Crear un mapa coroplético que muestre la distribución de un indicador clave (por ejemplo, densidad poblacional, acceso a servicios, etc.) a nivel de distrito o comuna, utilizando datos reales de una base espacial.',
    },
    {
      title: "Actividad 3: Simulación para Tomadores de Decisión (Roleplay)",
      icon: <FaChartLine className="text-3xl text-orange-600" />,
      description: 'En grupos, los analistas deben diseñar un tablero de "Control de Metas" para un Secretario o Director',
      reto: 'Simular una reunión de toma de decisiones donde los participantes presenten su tablero a un "Secretario" o "Director" (interpretado por un instructor o facilitador) y respondan preguntas críticas sobre la interpretación de los datos y las recomendaciones estratégicas basadas en sus visualizaciones.',
    }
  ];
      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid md:grid-cols-2 xl:grid-cols-3 gap-8">
          {objectives.map((objective) => (
            <Link href="/taller" key={objective.title}>
              <div className="bg-white rounded-2xl p-8 border border-slate-200 shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all duration-300 cursor-pointer">
                <div className="mb-5">
                  {objective.icon}
                </div>
